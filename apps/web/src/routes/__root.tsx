...
function RootLayout() {
  ...
  const snapshot = liveSnapshot.status === 'idle' ? bootstrapSnapshot : liveSnapshot;

  return (
    <div data-auth-state={snapshot.status} style={{ fontFamily: 'Inter, system-ui, sans-serif', minHeight: '100vh' }}>
      <header
        style={{
          display: 'flex',
