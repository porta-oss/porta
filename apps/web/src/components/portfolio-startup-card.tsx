...
import type { PortfolioBadge, PortfolioCardViewModel } from '../lib/portfolio-card';
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h3
          ...
          style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600, color: '#111827' }}
        >
          {viewModel.name}
        </h3>
        <span
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.75rem' }}>
        <span
          ...
          style={{
            ...
            color: viewModel.badge === 'blocked' || viewModel.badge === 'error' ? '#9ca3af' : '#111827',
          }}
        >
        ...
        {viewModel.trendSummary ? (
          <span
            ...
            style={{
              fontSize: '0.85rem',
              fontWeight: 500,
              color: viewModel.trendSummary.includes('+') ? '#065f46' : viewModel.trendSummary.includes('-') ? '#991b1b' : '#6b7280',
            }}
          >
            {viewModel.trendSummary}
          </span>
